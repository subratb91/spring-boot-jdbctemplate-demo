...
INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES (200,'Dummy Manager',7500.00,9500.00);
...
INSERT INTO departments(department_id,department_name,location_id) VALUES (300,'Dummy Department',1700);
...
--INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (400,'DummyFirst','DummyLast','dummy.gietz@sqltutorial.org','515.123.8181','1994-06-07',200,780.8787,205,300);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,job_id,salary,manager_id,department_id) VALUES (400,'DummyFirst','DummyLast','dummy.gietz@sqltutorial.org','515.123.8181',200,780.8787,205,300);
...
insert into users(id, name, email) values(1,'Chandler','chandler.bing@email.com');
insert into users(id, name, email) values(2,'Joey','joey.tribbiani@email.com');
insert into users(id, name, email) values(3,'Monica','monica.gellar@email.com');
insert into users(id, name, email) values(4,'Ross','ross.gellar@email.com');
insert into users(id, name, email) values(5,'Rachel','rachel.green@email.com');
insert into users(id, name, email) values(6,'Phoebe','phoebe.buffay@email.com');
